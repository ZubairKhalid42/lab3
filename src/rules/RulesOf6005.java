...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        // If it's available to others, it depends on the other conditions.
        if (availableToOthers) {
            // If it was written as coursework and properly cited, you can use it.
            if (writtenAsCourseWork && citingYourSource) {
                return true;
            }
        }
        
        // If the implementation is required by the assignment, you can use it.
        if (implementationRequired) {
            return true;
        }
        
        // If none of the above conditions are met, you may not use the code.
        return false;
    }
